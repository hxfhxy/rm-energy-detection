...
ArmTransform::ArmTransform(const Transform& T_base_ee,
                           const Transform& T_ee_cam)
    : T_base_ee_(T_base_ee), T_ee_cam_(T_ee_cam) {}

void ArmTransform::setBaseToEE(const Transform& T) {
    T_base_ee_ = T;
}

void ArmTransform::setEEToCamera(const Transform& T) {
    T_ee_cam_ = T;
}

Transform ArmTransform::computeBaseToObject(
    const Transform& T_cam_obj) const {
...
Transform ArmTransform::computeEEToObject(
    const Transform& T_cam_obj) const {
...
Transform ArmTransform::fromEuler(double roll_deg, double pitch_deg,
                                   double yaw_deg,
